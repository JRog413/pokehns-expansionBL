...
static bool8 ExtractMonDataToSummaryStruct(struct Pokemon *mon)
{
    ...
    case 0:
        ...
        sum->itemSlot2 = GetMonEquippedItem(GetMonData(mon, MON_DATA_EQUIPMENT_INDEX), 2);
        sum->itemSlot3 = GetMonEquippedItem(GetMonData(mon, MON_DATA_EQUIPMENT_INDEX), 3);
        sum->itemSlot4 = GetMonEquippedItem(GetMonData(mon, MON_DATA_EQUIPMENT_INDEX), 4);
