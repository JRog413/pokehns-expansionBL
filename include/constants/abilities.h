...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_FELINE_PROWESS = 311,
    ABILITY_OVERCHARGED = 312,
    ABILITY_PIERCING_DRILL = 313,
    ABILITY_DRAGONIZE = 314,
    ABILITY_DEADEYE = 315,
    ABILITY_CHEATING_DEATH = 316,
    ABILITY_AMBUSH = 317,
    ABILITY_READIED_ACTION = 318,
    ABILITY_RAGING_FIST = 319,
    ABILITY_GROWING_TOOTH = 320,
    ABILITY_MYSTIC_POWER = 321,
    ABILITY_CRYPTIC_POWER = 322,
    ABILITY_JUGGERNAUT = 323,
    ABILITY_MAJESTIC_BIRD = 324,
    ABILITY_FATAL_PRECISION = 325,
    ABILITY_SPEED_FORCE = 326,
    ABILITY_PRIMAL_MAW = 327,
    ABILITY_DUAL_WIELD = 328,
    ABILITY_ADRENALINE_RUSH = 329,
