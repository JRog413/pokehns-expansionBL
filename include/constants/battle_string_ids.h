...
enum StringID
{
    ...
    STRINGID_VAULTHUNTERSOULHARVESTHEAL,
    STRINGID_VAULTHUNTERSOULHARVESTPROC,
    STRINGID_VAULTHUNTERONESHOTONEKILL,
    STRINGID_VAULTHUNTEROUTMANEUVER,
    STRINGID_VAULTHUNTEROVERKILL,
    STRINGID_VAULTHUNTERPHASESHIELD,
    STRINGID_VAULTHUNTERRUIN,
